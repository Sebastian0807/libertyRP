...
dxGridListAddRow(grid, "Infos", false, true)
dxGridListAddRow(grid, "Vita|Credits#1", false, false)
dxGridListAddRow(grid, "Vita|Credits#2", false, false)
...
dxGridListAddRow(grid, "AutoFix, Rettungsdienst", false, false)
dxGridListAddRow(grid, "Polizei", false, false)
dxGridListAddRow(grid, "Reporter, Fahrschule,InterTrans", false, false)
...
dxGridListAddRow(grid, "Flugregeln/Infos", false,false)
...
function updateCamera ()
	...
	if rulesAlpha ~= 0 or showRules == true then
		...
		dxDrawShadowedText("The Liberty Village - Hilfemenü (forum.liberty-rl.de)",screenWidth/2-315,screenHeight/2-235, screenWidth, screenHeight, tocolor(240,240,180,255*rulesAlpha),tocolor(0,0,0,255*rulesAlpha), 1, "default-bold" , "left", "top", false, false, false, true)
	end
end
...
daStandartText = [[Herzlich Willkommen in der Hilfe von The Liberty Village!
...
Forum: forum.liberty-rl.de
Teamspeak³: ts.liberty-rl.de]]
...
daRules[4] = [[Bei Phoenix-City gibt es im Gegensatz zu anderen Servern wenige Pickups
...
daRules[5] = [[Tastenbelegung:
F1 - Hilfe
F11 - Karte
B - Klicksystem (Mauszeiger)
...
Z - Gang GUI
K - Limiter enfernen
L - Abblendlicht (Custombind: /licht)
num_1/ X - Motor

num_3 - Zentralverriegelung
num_7 - Anhänger abkuppeln (Custombind: /abkuppeln)
, . - | num_5, num_6 - Blinker (links, Warnblinker, rechts) [Custombinds: /indicator_left,/indicator_both,/indicator_right)
...
/häuseranzeigen
/sende/pay [Spielername] [Betrag]
/afk
/limit [geschwindikeit]
/togvi
/ego
/kuendigen
/hidetacho
...
/stopmiete [HausID]
/gc  - Gang Chat (geht nur wenn du in einer gang bist)
/werbung [Text] (Preis = 10 Vero pro Buchstabe)
/telefonbuch [Name]
/anrufen [Nummer] oder /call [Nummer]
/sms [Nummer] [Text]
/110 [Grund] - Polizei
/112 [Grund] - Sanitäter
/fschule [Grund] - Fahrlehrer
/taxi
/autofix [Grund] oder mit /adac [Grund] - Mechaniker ]]
 
 daRules[7] = [[Firmenchef:
...
/magnet
/markierte
/aufladen (Für Bikes auf einen Towtruck)
/abladen (Fur Bikes auf einen Towtruck)
/verwahrung
/abschleppen
/checktuev
/tuev
...
/lotto status [start = geöffnet stop = geschlossen]
/lotto preis [wie viel ein Ticket kosten soll]
/lotto max [wie viel mann max kaufen kann]
Newschat = taste U
...
/auspacken
/checkausliefern
/einladen (DFT-30 und Packer)
/ausladen (DFT-30 und Packer)
/ab
/abdel ]]
...
daRules[13] = [[Liberty Village basiert auf das Vita Village und ist daher anders, als der Großteil der übrigen Server in MTA:SA.
...
-> Komme wenn möglich auf unseren Teamspeak (IP: ts.Liberty-rl.de)
-> Habe Spaß auf The Phoenix-City
]]

daRules[14] = [[Du hast 2 verschiedene Möglichkeiten einen Beruf auszuüben. Einmal durch einen Hauptberuf und/oder mit einem Nebenjob.
...
Um bei einem Unternehmen zu arbeiten musst du dich im Forum (forum.liberty-rl.de) bei dem jeweiligen Chef in seinem Bereich bewerben.
...
daRules[15] = [[Fahrzeugkauf:
Du kannst dir dein Auto bei Ares Automobiles Kaufen.(Auf der F11 Karte Beim schwarzen A oder bei roten Auto)
...
Tod:
Solltest du bei einer Reise durch Phoenix-City gestorben sein wirst du kostenfrei vom Sanitäterwieder wiederbelebt oder im Krankenhaus in Las Venturas geheilt und respawnt.
...
daRules[19] =   [[Roleplay:
Roleplay ist eine gewisse Spielart, wie der Name es schon sagt,  ein Rollenpiel. Man spielt eine bestimmte Rolle, zum Beispiel Polizist oder Mechaniker. Auf Phoenix-City ist es ungern gesehen, wenn deine Rolle nicht in unser realistisches Spielszenario passt (z.B. Superschurke).
...
daRules[23] = [[§2 Rechte und Pflichten der Mitglieder
(1) Jedes Mitglied hat das Recht, bei Umfragen über verschiedene Liberty Village bezogene Themen seine Stimme abzugeben.
...
(2) Das Werben für forum.liberty-rl.de im Bereich anderer MTA-Server ist ebenfalls verboten. Verstoß wird mit einem permanenten Bann bestraft.
...
daRules[34] = [[§4 Abschleppwagengesetz
...
daRules[39] = [[§ 7 Halten und Parken
...
daRules[41] = [[§ 12 Übermäßige Straßenbenutzung
...
daRules[44] = [[Allgemeine Straftaten:
Körperverletzung mit Faust
--> 5000 Vero
Körperverletzung mit Schlagwaffe
--> 7500 Vero
Körperverletzung mit Schusswaffe
--> 10000 Vero + 15 Minuten
Körperverletzung mit Explosionswaffe
--> 15000 Vero + 25 Minuten
Schwere Körperverletzung
--> 20000 Vero + 35 Minuten
Beleidigungen
--> 500 Vero
...
daRules[45] = [[Straftaten gegenüber Staatsgewalt:
Befehlsverweigerung
--> 750 Vero
Falschaussage
--> 500 Vero
...
Beamtenbehinderung
--> 500 Vero
Knastausbruch (als Gangmitglied)
--> 5000 Vero + 15 Minuten
]]

daRules[46] = [[Besitz illegaler Gegenstände:
...
daRules[47] = [[Illegale Demonstrationen:
...
Versuchter Raub und Überfall
--> 2500 Vero + 10 Minuten
...
daRules[48] = [[Verkehrsdelikte #1:
Fahren ohne sichtbaren Kennzeichen
--> 1000 Vero + 4 Punkte + 1 Tag Fahrverbot
nicht vorhandener TÜV
--> 1000 Vero + 3 Punkt
Benutzung von Lachgaseinspritzung
--> 1000 Vero + 3 Punkte
Fahren mit gefärbten Schweinwerfer 
--> 1000 Vero + 2 Punkte
Fahren ohne Führerschein oder mit Führerscheinsperre
--> 4000 Vero + 6 Punkte + zusätzlich 3 Tage Fahrverbot
Gefährlicher Eingriff in den Strassenverkehr (z.b wenden,Entgegen der Fahrtrichtung,Rückwärtsfahren)
--> 1000 Vero + 3 Punkte
Fahren im abseits der Straße
--> 750 Vero
Unzulässiges Halten/Parken
--> 300 Vero
]]

daRules[49] = [[Verkehrsdelikte #2:
...
Rechts überholen
--> 500 Vero + 1 Punkt
Unerlaubtes Entfernen vom Unfallort/verursachen eines Unfall
--> 1000 Vero + 5 Punkte
...
--> 1,7 bis 2,3
1800 Vero + 8 Punkte + 2 Tage Fahrverbot 
--> 2,4 bis 2,9
2400 Vero + 11 Punkte + 3 Tage Fahrverbot + Führerscheinentzug von allen Bodenfahrzeugen]]
...
--> über 70 km/h
600 Vero + 4 Tage Fahrverbot + Führerscheinentzug des Jeweiligen gefahrenden Fahrzeugtyp

]]
daRules[51] = [[
Flugregeln/Infos:
Mit Helikoptern auf nicht geeignetem Gebiet landen (ausnahmen sind Diensthelikopter)
-->5000 Vero
Mit Flugzeugen auf nicht geeignetem Gebiet landen/starten
-->10000 Vero
Personen mit dem Rotor verletzen
-->5000 Vero
Tiefflug (ausgenommen Gebiet um Flughäfen)
-->5000 Vero
Kamikaze"-Fliegen
-->10000Vero + Flugscheinabnahme
Gefährung des Flugverkehrs (Fahren auf der Startbahn o.Ä.)
-->5000Vero + 3 PiF
Auf Helikoptern/Flugzeugen stehen und mitfliegen
--> 15.000 Vero 

====Weitere Informationen
Ihr könnt euch eure Punkte in Fleischberg (PiF) abbauen.
Dazu meldet ihr euch bei einem Polizist.
Der Preis wird wie folgt berechnet: 750 Vero = 1 PiF
Fahrverbot kann bei einen Cop weggekauft werden Pro Tag = 5000Vero
Sollte Jemand nicht Bezahlen Können so wird die Zeit so um gerechnet. 200Vero = 1 Minute
Sollte sich jemand Seine Knastzeit Wegkaufen wollen, dann wird es so um Gerechnet 1 Minute = 400Vero .
