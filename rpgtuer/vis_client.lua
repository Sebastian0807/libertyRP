                ...
                if (distanceToVehicle < minDistance) and (getDoor(lookAtVehicle)) then
                    if (not isVehicleLocked(lookAtVehicle)) then
                        ...
                        if (checkDoor ~= 4 ) then
                            ...
                            if (doorRatio <= 0) then
                                dxDrawText("#FFFFFFDrücke #00FF00" .. interactButton .. "#FFFFFF öffnen #00FF00" .. doorName .. "#FFFFFF!", screenWidth/2, screenHeight/2, screenWidth/2, screenHeight/2, tocolor(255, 255, 255, 255), 1, "arial", "center", "center", false, false, false, true, true)
                            else
                                dxDrawText("#FFFFFFDrücke #00FF00" .. interactButton .. "#FFFFFFschließen #00FF00" .. doorName .. "#FFFFFF!", screenWidth/2, screenHeight/2, screenWidth/2, screenHeight/2, tocolor(255, 255, 255, 255), 1, "arial", "center", "center", false, false, false, true, true)
                            end 
                        end
                    else
                        dxDrawRectangle ( screenWidth/2 - 100, screenHeight/2 - 8, 200, 16, tocolor( 0, 0, 0, 90 ))
