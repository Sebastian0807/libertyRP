...
button = { }
local carradios = {}
window = guiCreateWindow( ( rx - 295 ), ( ry / 2 - 253 / 2 ), 293, 253, "Liberty-RP Lautsprecher", false)
...
addEventHandler ( "onPlayerStartSpeakerBoxSound", root, function ( url, isCar )
	...
	if ( isCar ) then
		...
		exports.bone_attach:attachElementToBone ( speakerSound [ who ], who, 12, 0, 0, 0.42, 180, 0, 180 )
	end
end )
...
function attackerSpeakerOnPlayer ( thebox ) 
	exports.bone_attach:attachElementToBone ( thebox, source, 12, 0, 0, 0.42, 180, 0, 180 )
end
