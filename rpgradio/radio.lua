local radioStations = {
	...
	{name="1 live", url="http://www.wdr.de/wdrlive/media/einslive.m3u"},
	{name="FFN Nidersachen", url="http://player.ffn.de/tunein_ffn.pls"},
	...
	{name="Antenne Bayern", url="http://www.antenne.de/webradio/antenne.m3u "},
	...
	{name="I <3 2 Dance", url="https://www.iloveradio.de/ilove2dance.m3u"},
	{name="I <3 Bass", url="http://www.iloveradio.de/ilovebass.m3u"},
	{name="Sunshine Live", url="http://sunshinelive.hoerradar.de/sunshinelive-live-mp3-hq"},
